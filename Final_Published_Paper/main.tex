...
Training data consists of copyrighted cardiology textbooks and cannot be publicly shared. The trained CardioEmbed model weights are publicly available on HuggingFace at \url{https://huggingface.co/richardyoung/CardioEmbed-Qwen3-8B}. Training and evaluation code is available on GitHub at \url{https://github.com/ricyoung/CardioEmbed}. Evaluation datasets (BIOSSES, SciFact, NFCorpus) are publicly available through the MTEB benchmark framework.
